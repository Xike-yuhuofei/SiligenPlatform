...
- `docs/architecture/dxf-editor-strangler-progress.md`
- `docs/architecture/dxf-pipeline-strangler-progress.md`
- `docs/architecture/process-runtime-core-cutover.md`
