...
本目录保存 legacy 清理相关的历史计划、执行记录和阶段性判定。
...
- [legacy-cleanup-plan.md](./legacy-cleanup-plan.md)
- [legacy-cleanup-plan-v2.md](./legacy-cleanup-plan-v2.md)
- [legacy-removal-execution.md](./legacy-removal-execution.md)
