...
- 若本文档与当前仓库实现、机型事实或配置入口冲突，以 `docs/machine-model/multicard-io-and-wiring-reference.md`、`docs/troubleshooting/canonical-runbook.md` 和当前代码实现为准。
...
- 历史诊断说明见 [history/backend-cpp-library/README.md](../history/backend-cpp-library/README.md)。
