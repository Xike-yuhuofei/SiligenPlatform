...
|---|---|---|---|
| `siligen_control_gateway_tcp_adapter` | `siligen_transport_gateway` | `2026-03-19` | `docs/architecture/history/audits/alias-consumer-audit.md` |
| `siligen_tcp_adapter` | `siligen_transport_gateway` | `2026-03-19` | `docs/architecture/history/audits/alias-consumer-audit.md` |
| `siligen_control_gateway` | `siligen_transport_gateway_protocol` | `2026-03-19` | `docs/architecture/history/audits/alias-consumer-audit.md` |
...
3. 保留 `docs/architecture/history/audits/control-core-provenance-audit.md` 中记录的 provenance 证据，作为 `control-core/` 最终物理删除前的核对基线
