...
CLI cutover 详情见 `docs/architecture/history/closeouts/control-cli-cutover.md`。
...
`control-core` 侧 config/data/HIL/alias/source-root fallback 的后续切换与剩余门禁，见 `docs/architecture/history/closeouts/control-core-fallback-removal.md`。
