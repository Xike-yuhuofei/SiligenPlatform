...
- 临时开发分支必须使用项目级 skill `.agents/skills/new-task/SKILL.md` 规定的命名格式；`AGENTS.md`、`README.md` 等摘要说明均以该 skill 为准。
- 若创建额外 `worktree`，其命名与长度约束必须遵循项目级 skill `.agents/skills/new-task/SKILL.md`。
