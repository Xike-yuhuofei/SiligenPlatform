...
更新说明：本稿记录的是 Phase 12 收口状态；其中“多样本 nightly-performance”与“signed controlled HIL authority”已在 `./phase13-multisample-performance-and-signed-hil-closeout-20260402.md` 中继续收口。
