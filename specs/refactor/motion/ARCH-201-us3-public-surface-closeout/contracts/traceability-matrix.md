...
| --- | --- | --- | --- |
| P1 | Planning report public surface comes from `motion_planning/contracts/*` | `modules/workflow/application/include/application/usecases/dispensing/PlanningUseCase.h`, `apps/planner-cli/CommandHandlers.Dxf.cpp` | targeted build of `siligen_planner_cli` |
