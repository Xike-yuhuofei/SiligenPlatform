...
- story: `US4`
- source: `将 `M6 process-path` owner 入口归位到 `D:\Projects\SS-dispense-align\modules\process-path\CMakeLists.txt`、`D:\Projects\SS-dispense-align\modules\process-path\README.md`、`D:\Projects\SS-dispense-align\modules\process-path\contracts\README.md``
