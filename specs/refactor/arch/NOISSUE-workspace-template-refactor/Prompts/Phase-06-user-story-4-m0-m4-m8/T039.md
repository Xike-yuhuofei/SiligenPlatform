...
- story: `US4`
- source: `在 `D:\Projects\SS-dispense-align\tools\migration\validate_workspace_layout.py` 和 `D:\Projects\SS-dispense-align\specs\refactor\arch\NOISSUE-workspace-template-refactor\validation-gates.md` 增加 `M0/M4-M8` owner 路径断言`
