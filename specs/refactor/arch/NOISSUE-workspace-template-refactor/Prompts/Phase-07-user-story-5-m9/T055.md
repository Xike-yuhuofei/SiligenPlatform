...
- story: `US5`
- source: `同步运行时控制语义到 `D:\Projects\SS-dispense-align\docs\architecture\dsp-e2e-spec\dsp-e2e-spec-s07-state-machine-command-bus.md` 和 `D:\Projects\SS-dispense-align\docs\architecture\dsp-e2e-spec\dsp-e2e-spec-s08-system-sequence-template.md``
