...
- story: `US5`
- source: `将 runtime gateway 宿主职责归位到 `D:\Projects\SS-dispense-align\apps\runtime-gateway\CMakeLists.txt`，并在 `D:\Projects\SS-dispense-align\apps\control-tcp-server\CMakeLists.txt` 降级旧 owner 路径`
