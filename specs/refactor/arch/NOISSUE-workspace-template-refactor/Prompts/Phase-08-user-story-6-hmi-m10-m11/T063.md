...
- story: `US6`
- source: `同步验收与索引基线到 `D:\Projects\SS-dispense-align\docs\architecture\dsp-e2e-spec\dsp-e2e-spec-s09-test-matrix-acceptance-baseline.md` 和 `D:\Projects\SS-dispense-align\docs\architecture\dsp-e2e-spec\dsp-e2e-spec-s10-frozen-directory-index.md``
