...
- story: `US2`
- source: `在 `D:\Projects\SS-dispense-align\tools\migration\validate_workspace_layout.py` 和 `D:\Projects\SS-dispense-align\specs\refactor\arch\NOISSUE-workspace-template-refactor\validation-gates.md` 增加 canonical roots 与 shared-support 断言`
