...
- story: `US7`
- source: `在 `D:\Projects\SS-dispense-align\scripts\migration\legacy-exit-checks.py`、`D:\Projects\SS-dispense-align\tools\scripts\legacy_exit_checks.py`、`D:\Projects\SS-dispense-align\scripts\build\build-validation.ps1` 增加 canonical graph 与 legacy exit 断言`
