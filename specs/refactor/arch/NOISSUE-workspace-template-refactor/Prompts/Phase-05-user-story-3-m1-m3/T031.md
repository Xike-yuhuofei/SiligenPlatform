...
- story: `US3`
- source: `在 `D:\Projects\SS-dispense-align\tools\migration\validate_workspace_layout.py` 和 `D:\Projects\SS-dispense-align\specs\refactor\arch\NOISSUE-workspace-template-refactor\validation-gates.md` 增加 `M1-M3` owner 路径断言`
