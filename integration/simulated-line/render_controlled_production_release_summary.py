...
def _render_summary(
    *,
    ...
    simulated_md = report_dir / "simulation" / "simulated-line" / "simulated-line-summary.md"
    ...
    lines = [
        ...
        f"- `simulation/simulated-line/simulated-line-summary.json`：`{simulated_path}`",
        f"- `simulation/simulated-line/simulated-line-summary.md`：`{simulated_md}`",
...
def main() -> int:
    ...
    simulated_path = _resolve_path(
        ...
        report_dir / "simulation" / "simulated-line" / "simulated-line-summary.json",
    )
