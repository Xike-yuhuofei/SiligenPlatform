param(
    ...
    [string]$PublishLatestReportDir = "integration\\reports\\controlled-production-test",
...
& $buildScript -Profile $Profile -Suite simulation
...
New-Item -ItemType Directory -Path (Join-Path $resolvedPublishLatestReportDir "simulation\\simulated-line") -Force | Out-Null
...
Copy-Item -Path $simulatedLineSummaryJson -Destination (Join-Path $resolvedPublishLatestReportDir "simulation\\simulated-line\\simulated-line-summary.json") -Force
Copy-Item -Path $simulatedLineSummaryMd -Destination (Join-Path $resolvedPublishLatestReportDir "simulation\\simulated-line\\simulated-line-summary.md") -Force
