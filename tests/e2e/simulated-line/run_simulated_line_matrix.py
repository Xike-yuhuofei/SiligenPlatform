...
SCENARIOS = (
    ...
    MatrixScenario(
        ...
        expected_status="passed",
        args=("--mode", "compat", "--hook-control-cycle", "pause-resume-once"),
        required_assets=(
    ...
    MatrixScenario(
        ...
        expected_status="passed",
        args=("--mode", "compat", "--hook-control-cycle", "stop-reset-rerun"),
        required_assets=(
            "protocol.fixture.rect_diag_engineering",
            "baseline.simulation.compat_rect_diag",
        ),
