...
int main(int argc, char* argv[]) {
    ...
    try {
        // Phase 1: 创建并配置ApplicationContainer
        ...
        // Phase 2: 由容器构建面向 TCP 的应用门面，协议层不再直接拼装大量 use case。
        ...
        // Phase 3: 让 transport-gateway 完成命令分发器与 server 主体组装。
