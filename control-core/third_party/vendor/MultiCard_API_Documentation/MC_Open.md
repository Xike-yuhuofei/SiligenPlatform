...
|------|----------|----------|---------|----------|---------|
| 单卡默认配置 | 1 | "192.168.0.200" | 60000 | "192.168.0.1" | 60000 |
| 第二张卡 | 2 | "192.168.0.200" | 60001 | "192.168.0.2" | 60001 |
| 第三张卡 | 3 | "192.168.0.200" | 60002 | "192.168.0.3" | 60002 |
| 调试环境 | 1 | "10.129.41.200" | 60001 | "10.129.41.112" | 60001 |
...
- **单卡 vs 多卡**: 多卡场景下需要为每张卡调用MC_Open()，使用不同的端口号和IP地址
