...
using WorkflowRuntimeSupervisionPort = Siligen::Runtime::Service::Supervision::WorkflowRuntimeSupervisionPort;
...
TEST(WorkflowRuntimeSupervisionPortTest, MissingInnerPortReturnsNotInitializedError) {
    auto port = WorkflowRuntimeSupervisionPort(nullptr, BuildExecutionUseCase(), std::make_shared<FakeTerminalSync>());
...
TEST(WorkflowRuntimeSupervisionPortTest, SyncsTerminalJobOnceAfterObservedJobClears) {
    ...
    auto port = WorkflowRuntimeSupervisionPort(inner_port, execution_use_case, terminal_sync);
...
TEST(WorkflowRuntimeSupervisionPortTest, MissingExecutionUseCaseDropsStaleObservedJob) {
    auto inner_port = std::make_shared<FakeRuntimeSupervisionPort>();
    inner_port->next_snapshot.active_job_id = "job-terminal";

    auto terminal_sync = std::make_shared<FakeTerminalSync>();
    auto port = WorkflowRuntimeSupervisionPort(inner_port, nullptr, terminal_sync);
