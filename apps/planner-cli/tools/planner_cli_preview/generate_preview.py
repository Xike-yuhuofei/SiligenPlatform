...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--curve-tolerance-mm", type=float, default=0.25, help="Polyline flattening tolerance in mm")
    parser.add_argument("--max-points", type=int, default=12000, help="Maximum sampled points kept in the preview")
    parser.add_argument(
        "--deterministic",
        action="store_true",
