...
public:
    ...
    ~CleanupFilesUseCase() = default;

    // 禁止拷贝和移动
    CleanupFilesUseCase(const CleanupFilesUseCase&) = delete;
    CleanupFilesUseCase& operator=(const CleanupFilesUseCase&) = delete;
