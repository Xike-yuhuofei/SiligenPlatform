...
using Siligen::Domain::System::Redundancy::Ports::BatchWriteSummary;
...
class RedundancyGovernanceUseCases {
   ...
   private:
    ...
    std::shared_ptr<Siligen::Domain::System::Redundancy::Ports::IRedundancyRepositoryPort> repository_;
