...
using Siligen::Application::UseCases::Dispensing::PreviewSnapshotPoint;
...
PreviewSnapshotResponse WorkflowPreviewSnapshotService::BuildResponse(
    ...
    response.point_count = input.point_count;
    ...
    response.polyline_source_point_count = static_cast<std::uint32_t>(source_count);
