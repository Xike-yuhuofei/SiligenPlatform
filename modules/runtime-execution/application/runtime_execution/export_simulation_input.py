...
from runtime_execution.contracts import DEFAULT_EXPORTS, ExportDefaults, ValveConfig
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Export runtime simulation compatible JSON from a PathBundle (.pb)."
    )
    ...
    parser.add_argument("--ellipse-max-seg", type=float, default=1.0, help="Linearization step in mm for ellipse primitives")
