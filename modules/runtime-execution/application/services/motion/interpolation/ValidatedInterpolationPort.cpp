...
ValidatedInterpolationPort::ValidatedInterpolationPort(
    ...
    : inner_(std::move(inner)),
      validator_(std::make_unique<Siligen::Domain::Motion::DomainServices::InterpolationCommandValidator>()) {
}

ValidatedInterpolationPort::~ValidatedInterpolationPort() = default;
