...
class CalibrationExecutionService final {
   public:
    explicit CalibrationExecutionService(
        std::shared_ptr<ICalibrationExecutionPort> execution_port,
        std::shared_ptr<ICalibrationResultSink> result_sink) noexcept;

    CalibrationExecutionService(const CalibrationExecutionService&) = delete;
    CalibrationExecutionService& operator=(const CalibrationExecutionService&) = delete;
    CalibrationExecutionService(CalibrationExecutionService&&) = delete;
    CalibrationExecutionService& operator=(CalibrationExecutionService&&) = delete;
