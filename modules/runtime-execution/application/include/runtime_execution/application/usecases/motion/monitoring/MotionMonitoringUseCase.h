...
class MotionMonitoringUseCase {
   public:
    ...
    Result<std::vector<Siligen::RuntimeExecution::Contracts::Motion::IOStatus>> ReadAllDigitalInputStatus() const;
    Result<Siligen::RuntimeExecution::Contracts::Motion::IOStatus> ReadDigitalOutputStatus(int16 channel) const;
    Result<std::vector<Siligen::RuntimeExecution::Contracts::Motion::IOStatus>> ReadAllDigitalOutputStatus() const;
