...
using Siligen::RuntimeExecution::Application::Services::Calibration::CalibrationExecutionService;
...
TEST(CalibrationExecutionServiceTest, RunsThroughStatesAndPersistsResult) {
    ...
    CalibrationExecutionService service(execution_port, result_sink);
...
TEST(CalibrationExecutionServiceTest, RejectsInvalidRequest) {
    auto execution_port = std::make_shared<FakeCalibrationExecutionPort>();
    auto result_sink = std::make_shared<FakeCalibrationResultSink>();
    CalibrationExecutionService service(execution_port, result_sink);
