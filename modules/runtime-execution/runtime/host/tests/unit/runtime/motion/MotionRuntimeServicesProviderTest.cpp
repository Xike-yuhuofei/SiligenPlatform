...
using MotionRuntimeServicesProvider =
    Siligen::RuntimeExecution::Host::Motion::MotionRuntimeServicesProvider;
...
TEST(MotionRuntimeServicesProviderTest, ReturnsEmptyBundleWhenPortIsMissing) {
...
TEST(MotionRuntimeServicesProviderTest, CreatesMotionServicesFromRuntimePort) {
    MotionRuntimeServicesProvider provider;
