...
MODULE_ROOT = WORKSPACE_ROOT / "modules" / "dxf-geometry"
PACKAGE_ROOT = MODULE_ROOT / "application"
RUNTIME_EXECUTION_PACKAGE_ROOT = WORKSPACE_ROOT / "modules" / "runtime-execution" / "application"
MOTION_PLANNING_PACKAGE_ROOT = WORKSPACE_ROOT / "modules" / "motion-planning" / "application"
FIXTURE_ROOT = WORKSPACE_ROOT / "shared" / "contracts" / "engineering" / "fixtures" / "cases" / "rect_diag"
PACKAGE_ROOTS = (
    RUNTIME_EXECUTION_PACKAGE_ROOT,
    MOTION_PLANNING_PACKAGE_ROOT,
    PACKAGE_ROOT,
)
